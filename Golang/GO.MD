...
* ### There are also functions for Cos, Tan, Acos, Asin, Atan, Asinh, Acosh, Atanh, Atan2, Cosh, Sinh, Sincos, Htpot
...
## Go passes the value to functions so it isn't changed even if the same variable name is used
```go
	f3 := 5
